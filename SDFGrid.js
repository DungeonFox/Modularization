...
const IDB_NAME    = 'SDFFieldDB';
const IDB_VERSION = 7;

const STORE_META  = 'meta';
const STORE_BASE  = 'base';        // Int16 SDF per-layer (kept)
const STORE_BASEZ = 'base_zero';   // Float32 zero template per schemaId
const STORE_LAYER = 'overlay_layers';
const STORE_LMETA = 'overlay_layers_meta';
...
function normalizeBucketName(x){
...
function pickNucleusByDirection(w,h,dir){
